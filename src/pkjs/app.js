    ...
    function(e) {
        ...
        try {
            ...
            */
            ...
            // Send to Pebble
            var dictionary = {
              "TIME_COLOR": parseInt(configuration.time_color, 16),  // TODO color not validated
              "BACKGROUND_COLOR": parseInt(configuration.background_color, 16),  // TODO color not validated
              "VIBRATE_ON_DISCONNECT": configuration.vibrate_disconnect
            };
